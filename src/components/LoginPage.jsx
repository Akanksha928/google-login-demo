  ...
  return (
    <div className="login-page">
      <div className="login-card animate-fadeUp">
        ...
        <button className={`google-btn${loading ? ' loading' : ''}`} onClick={handleLogin} disabled={loading}>
          <GoogleIcon />
          {loading ? 'Signing you in…' : 'Continue with Google'}
        </button>

        <p className="terms">
          By continuing, you agree to our <span className="terms-link">Terms of Service</span>
